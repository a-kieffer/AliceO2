                             ...
                             const std::string path = "./")
{
  ...
  TNtuple trackdeltaTanLambdas("dtl", "dtl", "deltatanlambda:c0z:c0r:c1z:c1r:c2z:c2ri:valid");
  ...
  // parameters.phiCut = 5.6f;
  // parameters.pairCut=0.2f;
  // parameters.tanLambdaCut = 3.5f;
  //\Settings
